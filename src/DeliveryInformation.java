...
public class DeliveryInformation extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DeliveryInformation
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeliveryInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeliveryInformation().setVisible(true);
            }
        });
    }
    ...
    private void setInitiaValues() {
        jtfAddress.setText("Farlim");
        jtfContactNo.setText("0123456789");
        jtfDeliverymanId.setText("D01");
        jtfEmergencyContactNo.setText("0111111111");
        jtfIcNo.setText("99999999999");
        jtfLevel.setText("1");
        jtfName.setText("Cheong Wei Kit");
        jtfStatus.setText("Available");
        setLocationRelativeTo(null);
        setTitle("Delivery men Details");
    }
}
